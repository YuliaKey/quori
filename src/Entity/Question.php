...
class Question
{
    ...
    #[Assert\NotBlank(message: "Veillez definir un titre")]
    #[Assert\Length(min: 20,minMessage: "Veillez detailler votre titre", max: 255, maxMessage: "Le titre est trop long")]
    private ?string $title = null;

    #[ORM\Column(type: Types::TEXT)]
    #[Assert\NotBlank(message: "Veillez definir un titre")]
    #[Assert\Length(min: 20,minMessage: "Veillez detailler votre question")]
